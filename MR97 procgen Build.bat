...
set compilerpath=C:\FreeBASIC\fbc32.exe

set prjdrive=C
set prjroot=\ag
set prjspc=mr97 procgen
set prjext=.bas
set prjres=.\rc\mr97 procgen.rc
set prjsuffix=97 procgen
set project=MR
...
"%compilerpath%" "%prjdrive%:%prjroot%\%prjspc%\%project%%prjsuffix%%prjext%" -lang "fblite" -s gui "%prjres%" > "%debugout%" 2>&1
