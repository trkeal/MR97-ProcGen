...
5 ln_1400: p0 = r0: go = 0: ky = 0: bm = 0: m0i = 1
6
...
36 c3 = 0: x0 = xx: y0 = yy: ln_200: NEXT xx: NEXT yy
...
41 s$ = CHR$(g(yy, xx))
42 ll = 0: ln_100: IF ll = 1 THEN NP = 1
43 :
NEXT yy
...
FOR yy = y TO y + ys - 1
51 c3 = 1: x0 = xx: y0 = yy: ln_200
52 NEXT yy: NEXT xx
53 dn = 0: de = 0: ds = 0: dw = 0: FOR xx = x TO x + xs - 1: FOR yy = y TO y + ys - 1


54 s1$ = CHR$(g(yy - 2, xx)): s2$ = CHR$(g(yy - 1, xx))
55 ll = 0: ln_150: ln_160: IF ll = 2 AND dn = 1 THEN dn = 0
56 ll = 0: ln_110: ln_160: IF ll = 2 AND dn = 0 THEN c3 = 2: y0 = yy - 1: x0 = xx: ln_200: dn = 1

57 s1$ = CHR$(g(yy, xx + 2)): s2$ = CHR$(g(yy, xx + 1))
58 ll = 0: ln_150: ln_160: IF ll = 2 AND de = 1 THEN de = 0
59 ll = 0: ln_110: ln_160: IF ll = 2 AND de = 0 THEN c3 = 2: y0 = yy: x0 = xx + 1: ln_200: de = 1

60 s1$ = CHR$(g(yy + 2, xx)): s2$ = CHR$(g(yy + 1, xx))
61 ll = 0: ln_150: ln_160: IF ll = 2 AND ds = 1 THEN ds = 0
62 ll = 0: ln_110: ln_160: IF ll = 2 AND ds = 0 THEN c3 = 2: y0 = yy + 1: x0 = xx: ln_200: ds = 1

63 s1$ = CHR$(g(yy, xx - 2)): s2$ = CHR$(g(yy, xx - 1))
64 ll = 0: ln_150: ln_160: IF ll = 2 AND dw = 1 THEN dw = 0
65 ll = 0: ln_110: ln_160: IF ll = 2 AND dw = 0 THEN c3 = 2: y0 = yy: x0 = xx - 1: ln_200: dw = 1


66 s1$ = CHR$(g(yy - 1, xx - 1)): s2$ = CHR$(g(yy - 1, xx)): s3$ = CHR$(g(yy, xx - 1))
67 ll = 0: ln_110: ln_160: ln_170: IF ll = 3 THEN c3 = 2: y0 = yy - 1: x0 = xx: ln_200

68 s1$ = CHR$(g(yy - 1, xx + 1)): s2$ = CHR$(g(yy - 1, xx)): s3$ = CHR$(g(yy, xx + 1))
69 ll = 0: ln_110: ln_160: ln_170: IF ll = 3 THEN c3 = 2: y0 = yy: x0 = xx + 1: ln_200

70 s1$ = CHR$(g(yy + 1, xx + 1)): s2$ = CHR$(g(yy + 1, xx)): s3$ = CHR$(g(yy, xx + 1))
71 ll = 0: ln_110: ln_160: ln_170: IF ll = 3 THEN c3 = 2: y0 = yy + 1: x0 = xx: ln_200

72 s1$ = CHR$(g(yy + 1, xx - 1)): s2$ = CHR$(g(yy + 1, xx)): s3$ = CHR$(g(yy, xx - 1))
73 ll = 0: ln_110: ln_160: ln_170: IF ll = 3 THEN c3 = 2: y0 = yy: x0 = xx - 1: ln_200

75 NEXT yy: NEXT xx: COLOR 15, 0

76 FOR r = 1 TO (INT(xs * ys) / (ic) + 1) - 1
77 c3 = 3: x0 = INT(RND(1) * xs) + x: y0 = INT(RND(1) * ys) + y: ln_200
78 NEXT r
...
86 ll = 0: lc = 0: FOR x0 = xx - 1 TO xx + 1: FOR y0 = yy - 1 TO yy + 1: s1$ = CHR$(g(y0, x0)): ln_150: IF ll > lc THEN lc = ll: IF ll < 3 THEN lxa(ll) = x0: lya(ll) = y0
87 NEXT y0: NEXT x0: IF ((ll = 2) * (ABS(lxa(1) - lxa(2)) < 2) * (ABS(lya(1) - lya(2)) < 2)) + (ll < 2) THEN c3 = 1: x0 = xx: y0 = yy: ln_200
...
300 :
'''start = TIMER
GOSUB 250: ln_1000: GOSUB 220: y0 = py: x0 = px: GOSUB 410
301
...
313 IF INSTR(1, "+-", c$) > 0 THEN ln_1300
...
324 IF c$ = "v" AND knowledge(p0, 2) > 0 AND g2 < g0 THEN r = INT(RND(1) * 3) + 4: IF currentstats(p0, 4) >= r THEN ln_1200: currentstats(p0, 4) = currentstats(p0, 4) - r: r$ = STR$(r): r$ = "[Cast 'Vision']" + "[Mp -" + ltrim$(r$) + "]"
325 IF c$ = "t" AND knowledge(p0, 3) > 0 THEN r = INT(RND(1) * 6) + 4: IF currentstats(p0, 4) >= r THEN ln_2000: currentstats(p0, 4) = currentstats(p0, 4) - r: r$ = STR$(r): r$ = "[Cast 'Tinker']" + "[Mp -" + ltrim$(r$) + "]"
326 IF c$ = "p" AND knowledge(p0, 4) > 0 THEN r = INT(RND(1) * 3) + 5: IF currentstats(p0, 4) >= r THEN ln_1900: currentstats(p0, 4) = currentstats(p0, 4) - r: r$ = STR$(r): r$ = "[Cast 'Passage']" + "[Mp -" + ltrim$(r$) + "]"
327 IF c$ = "h" AND knowledge(p0, 5) > 0 THEN r = INT(RND(1) * 2) + 4: IF currentstats(p0, 4) >= r THEN ln_1800: currentstats(p0, 4) = currentstats(p0, 4) - r: r$ = STR$(r): r$ = "[Cast 'Heal']" + "[Mp -" + ltrim$(r$) + "]"
328 IF c$ = "f" AND knowledge(p0, 6) > 0 THEN r = INT(RND(1) * 5) + 4: IF currentstats(p0, 4) >= r THEN ln_1200: currentstats(p0, 4) = currentstats(p0, 4) - r: r$ = STR$(r): r$ = "[Cast 'Flare']" + "[Mp -" + ltrim$(r$) + "]"
340 IF c$ = "b" AND bm > 0 THEN r = 1: IF bm >= r THEN ln_1500: bm = bm - r: r$ = STR$(r): r$ = "[Used Bomb][Bomb -" + ltrim$(r$) + "]"
350 'gold
...
393 GOSUB 600
394 IF CHR$(g(py, px)) = "@" THEN ln_1700
...
456 'gain character
IF r >= 16 AND r <= 17 THEN ln_1400: r = 16: IF rr = 0 THEN 450
